...
class TransactionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_item" do
    assert_difference('TransactionItem.count') do
      post transaction_items_url, params: { transaction_item: { amount: @transaction_item.amount, medicine_type_id: @transaction_item.medicine_type_id } }
    end
  ...
  test "should update transaction_item" do
    patch transaction_item_url(@transaction_item), params: { transaction_item: { amount: @transaction_item.amount, medicine_type_id: @transaction_item.medicine_type_id } }
