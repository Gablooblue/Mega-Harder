...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { doctor_id: @prescription.doctor_id, user_id: @prescription.user_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { doctor_id: @prescription.doctor_id, user_id: @prescription.user_id } }
